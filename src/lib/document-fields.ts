...
export const documentFieldsToAnalyze: DocumentField[] = [
  ...
  {
    name: 'address',
    description: 'Complete address with the following structure: firstLine (address line 1), secondLine (address line 2), city, zipCode, country, e.g. { "firstLine": "123 Main St", "secondLine": "Apt 1", "city": "Springfield", "zipCode": "12345", "country": "united_states" }',
    type: 'address',
    required: true
  },
  {
  ...
  {
    name: 'workStatus',
    description: 'Work status, must be one of: "EMPLOYEE", "ENTREPRENEUR", "UNEMPLOYED", "RETIRED", "STUDENT", "OTHER"',
    type: 'string'
  },
  {
    name: 'profession',
 ...
 */
export function getFieldsForDocument(documentType: keyof typeof documentSpecificFields): DocumentField[] {
