...
export default function FilePreview({ url, label, customClasses, isMissing = false }: FilePreviewProps) {
  const isPdf = url?.endsWith('.pdf')

  return (
    <div className={`passsport-doc flex flex-col gap-4 rounded border border-muted px-4 py-3 ${customClasses}`}>
